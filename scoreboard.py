...
class Scoreboard:
	"""A calss to report scoring info"""
	...
	def prep_score(self):
		...
		#display the color at the top right of the screen
	...
	def prep_level(self):
		"""prep the level into rendered image"""
		level_str = str(self.stats.level)
		self.image_level = self.font.render(level_str, True, self.text_color, self.settings.bg_color)
